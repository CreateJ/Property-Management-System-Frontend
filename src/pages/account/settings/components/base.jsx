...
const BaseView = (props) => {
  ...
  return (
    <div>
      ...
      >
        <ProFormText label="姓名" name="name" width="md" />
        <ProFormText label="身份证号" name="id_code" width="md" readonly />
        <ProFormDatePicker label="生日" name="birthday" width="md" readonly />
        <ProFormText label="微信号" name="wechat" width="md" />
        <ProFormText label="邮箱" name="email" width="md" />
