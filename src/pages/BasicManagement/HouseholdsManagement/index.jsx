...
import { sexTransToFrontend, timeTransToBackend, timeTransToFrontend } from '@/utils/transformUtils';
import {
  deleteHousehold,
  getHouseholdData,
  householdRegister, modifyHousehold,
  queryHouseholdData,
...
const HouseholdsManagement = (props) => {
  ...
  const queryData = async(params, _s, _f) => {
    const queryParams = {page:params.current, page_size:params.pageSize, user_type:1, ...params};
